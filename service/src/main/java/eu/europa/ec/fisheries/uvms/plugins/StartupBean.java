...
import eu.europa.ec.fisheries.uvms.plugins.service.FileHandlerBean;
...
public class StartupBean extends PluginDataHolder {
    ...
    private String REGISTER_CLASS_NAME = "FluxRestPlugin";
    ...
    public void startup() {
        ...
        LOG.info("classname:" + REGISTER_CLASS_NAME);
        ...
        serviceType = ServiceMapper.getServiceType(
                ...
                getApplicationName(),
                "Plugin for sending FLUXVesselPositionMessage to REST endpoints",
                PluginType.OTHER,
                getPluginResponseSubscriptionName());

        register();

        LOG.debug("Settings updated in flux-vesselposition-rest {}", REGISTER_CLASS_NAME);
